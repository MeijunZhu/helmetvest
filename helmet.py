...
class YoLov5TRT(object):
    ...
    def infer(self, image_raw):
        ...
        print("input_image.ravel():"+str(input_image.ravel()))
        print("ihost_inputs:"+str(host_inputs[0]))
...
def main_camera():
    ...
    engine_file_path = "build/helmetlast.engine"

    # YoLov5TRT instance
    yolov5_wrapper = YoLov5TRT(engine_file_path)
    print("yolov5_wrapper:"+str(yolov5_wrapper))
...
if __name__ == "__main__":
    colors=[[0,255,0],[0,0,255],[0,255,0],[0,0,255]]
    categories = ["helmet","no_helmet","vest","no_vest"]
    main_camera()
